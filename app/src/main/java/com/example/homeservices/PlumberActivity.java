...
public class PlumberActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profileButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent profileButton = new Intent(PlumberActivity.this,ProfileActivity.class);
    ...
    private void jsonrequest() {
        ...
        request = new StringRequest(Request.Method.GET,JSON_URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    JSONArray jsonArray = jsonObject.getJSONArray("plumber");
        ...
        requestQueue = Volley.newRequestQueue(PlumberActivity.this);
